...
| | |
|---|---|
| 🎯 **강점** | 교육 PM/PL 경험 기반의 서비스 기획력 + 사용자 흐름 설계 |
| 🛠 **현재** | React · TypeScript · Spring Boot · JPA · MySQL 풀스택 개발 |
| 🤖 **프로젝트** | AI 모의면접 플랫폼 I-Poten 개발 중 |
| 💡 **관심사** | 실제 불편을 해소하는 UX 개선, 유지보수하기 쉬운 코드 구조 |
...
| 기능 | 설명 |
|---|---|
| 🔍 **PotenWord** | IT 개발 용어를 분야별로 탐색·학습하는 용어 검색 서비스 |
| 📓 **PotenNote** | 필요한 용어를 저장하고 복습하는 개인 학습 노트 |
| ✏️ **PotenQuiz** | 저장 개념 기반의 반복 학습 퀴즈 기능 |

**담당 역할**
- React · TypeScript 기반 화면 구현 및 사용자 상태별 분기 처리
